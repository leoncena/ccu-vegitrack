...
-- V2: Loose policies for mockup/testing - any authenticated user can manage farms and products
-- ============================================
...
-- Loose policies: any authenticated user can manage farms and products (for mockup/testing)
...
CREATE POLICY "Authenticated users can manage product labels" ON product_labels
  FOR ALL TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can manage quality indicators" ON quality_indicators
  FOR ALL TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can manage certifications" ON certification_ledger
  FOR ALL TO authenticated
  USING (true);
...
CREATE POLICY "Authenticated users can manage sustainability metrics" ON sustainability_metrics
  FOR ALL TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can manage farms" ON farms
  FOR ALL TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can manage farmer stories" ON farmer_stories
  FOR ALL TO authenticated
  USING (true);

CREATE POLICY "Authenticated users can manage farming practices" ON farming_practices
  FOR ALL TO authenticated
  USING (true);
