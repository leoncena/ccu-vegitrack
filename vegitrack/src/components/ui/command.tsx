...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      style={{ marginTop: 'calc(var(--spacing-card) / 2)' }}
      {...props}
    />
  )
}
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        "data-[selected=true]:[background-color:var(--color-success-surface)] data-[selected=true]:[color:var(--color-text)]",
        className
      )}
      style={{
        paddingTop: 'calc(var(--spacing-card) / 2)',
        paddingBottom: 'calc(var(--spacing-card) / 2)',
        marginLeft: 'calc(var(--spacing-card) * 0.5)',
        marginRight: 'calc(var(--spacing-card) * 0.5)',
